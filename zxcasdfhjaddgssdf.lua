...
do -- checks
    ...
    --
	if not isfolder("medusa/Configs/") then
		makefolder("medusa/Configs/");
	end
	--
	if not isfolder("medusa/Luas/") then
		makefolder("medusa/Luas/");
	end
end
--
do -- macros
...
do -- fonts
    function medusa.fonts.cache:Register_Font(Name, Weight, Style, Asset)
        if not isfolder("medusa") then makefolder("medusa") end
        local asset = "medusa/" .. Asset.Id;
        local font = "medusa/" .. Name .. ".font";
...
local library = ({
    open = true,
    font_size = 6,
    font = medusa.fonts.options.Templeos,
    ...
    menu_colors = {
        ...
        inline_accent = Color3.fromRGB(71, 80, 255),
